...
class remote extends CI_Controller {
	...
	public function refresh() {
	   ...
	   $url=$task_domain."/sunyardEngine/refresh?refreshTaskID=".$taskID.'&refreshTaskType=2'.'&OID='.$OID.'&enterWay='.$enterWay;
       ...
       $refresh_html = $this->load->view('include/yzm_refresh',array("refresh"=>$obj[0]),true); 
