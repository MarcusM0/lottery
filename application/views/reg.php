...
<!--        <div style="float:right;padding-right:20px;"><a href="<?php echo site_url("index")?>"><img src="/images/logo_bottom.png"/></a></div>    -->
    ...
    <a style="float:left;color:black" href="<?php echo site_url("agree")?>" target="_blank">使用协议</a><span id="regmsg" style="padding-left:20px;color:red;display:none">请到您的邮箱查收邮件并激活账户!</span>   <a style="float:right;padding-right:20px;;color:black" href="<?php echo site_url("login")?>">已有账号?登录</a>
