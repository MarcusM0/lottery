...
-- Records of login
-- ----------------------------
INSERT INTO `login` VALUES ('36', 'marcus@mail.com', 'e10adc3949ba59abbe56e057f20f883e', null, '48', '2014-08-07 18:48:40');
...
INSERT INTO `lottery_issue` VALUES ('8', '6', '1', '00');
INSERT INTO `lottery_issue` VALUES ('9', '6', '2', '00');
INSERT INTO `lottery_issue` VALUES ('10', '6', '3', '00');
INSERT INTO `lottery_issue` VALUES ('11', '6', '4', '00');
INSERT INTO `lottery_issue` VALUES ('12', '6', '5', '444');
INSERT INTO `lottery_issue` VALUES ('19', '6', '6', '444');
INSERT INTO `lottery_issue` VALUES ('20', '6', '7', '444');
INSERT INTO `lottery_issue` VALUES ('21', '6', '8', '444');

-- ----------------------------
-- Table structure for lottery_num_code
-- ----------------------------
DROP TABLE IF EXISTS `lottery_num_code`;
CREATE TABLE `lottery_num_code` (
  `code` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `num_value` varchar(255) DEFAULT NULL,
  `num_position` int(11) DEFAULT NULL,
  `num_seq` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lottery_num_code
-- ----------------------------
INSERT INTO `lottery_num_code` VALUES ('xxx', '', '254', '1', '8');
INSERT INTO `lottery_num_code` VALUES ('yyy', '', '435', '1', '2');
INSERT INTO `lottery_num_code` VALUES ('xxc', '', '31', '1', '3');

-- ----------------------------
-- Table structure for lottery_winner_log
-- ----------------------------
DROP TABLE IF EXISTS `lottery_winner_log`;
CREATE TABLE `lottery_winner_log` (
  `id_lottery_winner_log` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_user` int(11) unsigned DEFAULT NULL,
  `id_prize` int(10) unsigned DEFAULT NULL,
  `issue_num` int(11) DEFAULT NULL,
  `issue_result` varchar(255) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id_lottery_winner_log`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lottery_winner_log
-- ----------------------------
INSERT INTO `lottery_winner_log` VALUES ('2', '48', '6', '5', '444', '2014-08-11 06:41:47');
...
INSERT INTO `user_lottery_action` VALUES ('2', '48', '444', '12', '2014-08-06 07:12:56');
